...
export class PasswordDialog extends BaseDialog<IBaseDialogProps, IPasswordDialogState> {
    ...
    public show(params: { onProceed: () => void; onShow?: () => void; onDismiss?: () => void }): void {
    ...
    protected renderInside(): JSX.Element {
        ...
        return (
            <View style={Styles.mainContainerStyle}>
                <BaseText style={Styles.titleStyle} text={title} />
                <View style={Styles.headerSpacer} />
                <View style={{ width: '100%', alignItems: 'center' }}>
                    <LabeledContainer labelText={message} errorText={this.state.errorMessage}>
                        <View style={Styles.iconEditTextView}>
                            <SafeTouch style={Styles.showPasswordSafeTouch} onPress={onShowPasswordIconTouch}>
                                {icon}
                            </SafeTouch>
                            <EditText
